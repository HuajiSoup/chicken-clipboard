...
import { EditorContext, EditState, SettingsContext } from "../../App";
...
const ClipEditor: React.FC<ClipEditorProps> = ({ editState }) => {
  ...
  const handleSave = () => {
    ...
    invoke("update_clip", { id, content: newContent, updateTime: settings.update_time })
      .then(() => {
        handleReturn();
